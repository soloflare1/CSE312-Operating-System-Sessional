...
// Enter Burst time & Priority for Process 1: 10 3
// Enter Burst time & Priority for Process 2: 1 1
// Enter Burst time & Priority for Process 3: 2 2
...
int main()
{
    ...
    int bt[n], wt[n], tat[n], priority[n], process[n];
    ...
    // Sort according to priority (lower value = higher priority)
    for (int i = 0; i < n - 1; i++)
    {
        for (int j = i + 1; j < n; j++)
        {
